...
[Signal]
public delegate void PowerUpClickedEventHandler();

[GlobalClass]
public partial class PowerUpPanel : PanelContainer
{
    [Signal]
    public delegate void PowerUpClickedEventHandler(string key);
