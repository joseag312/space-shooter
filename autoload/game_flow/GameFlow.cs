...
public partial class GameFlow : ParallaxBackground
{
    public static GameFlow Instance { get; private set; }

    [Export] private ParallaxLayer _starLayer;
    ...
    {
        _starLayer.Visible = true;
        _slowLayer.Visible = true;
        _fastLayer.Visible = true;

        _starLayer.Modulate = new Color(1, 1, 1, 1);
    ...
    {
        _starLayer.Visible = false;
        _slowLayer.Visible = false;
        _fastLayer.Visible = false;

        _starLayer.Modulate = new Color(1, 1, 1, 0);
    ...
    public async void FadeInStars()
    {
        ...
        tween.TweenProperty(_starLayer, "modulate:a", 1f, 1.2f);
    ...
    public async void FadeOutStars()
    {
        ...
        tween.TweenProperty(_starLayer, "modulate:a", 0f, 1.2f);
        await ToSignal(tween, "finished");
